...
import { ExpandLess, ExpandMore, FileCopy, RemoveOutlined, UploadFile, EmojiObjectsOutlined } from '@mui/icons-material';
  ...
  return (
    ...
    >
      {itemList.map((v, i) => {
        ...
        if (roleAccess && roleAccess[v.id]?.read) return (
          <div key={i}>
            <ListItemButton
